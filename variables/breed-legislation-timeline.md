...
## Italy -- NEW Session 11
**Source: cross-referenced from data/by-country/Italy.md (Alberghina et al. 2023 for bite-hospitalisation data; "Fatal Dog Attacks in Italy 2009-2025," MDPI/PMC12729952, for the legislative-era comparison) -- [quality: A]**

Italy had national breed-specific legislation from 1984 to 2009 (an "elenco di razze pericolose," dangerous-breeds list, per the fatal-attacks paper's own framing -- the specific 1984 statute and exact repeal-date/mechanism were not independently sourced this session beyond the fatal-attacks paper's citation and a set of Italian pet-law blogs surfaced in a search, none of which were fetched for a primary citation). In 2009 Italy moved to an owner-accountability/behavioural-assessment model, removing the breed-specific list nationally.

| Date | Change | Detail | Source |
|------|--------|--------|--------|
| 1984 | National breed-specific "dangerous breeds" list introduced | Exact statute not independently verified this session | Cited by the fatal-attacks paper; not independently sourced |
| 2009 | National breed-specific list repealed; owner-accountability/behavioural-assessment model adopted | Exact ordinance/mechanism not independently verified this session (several Italian-language blog sources reference a "Martini ordinance" eliminating the list, not fetched for primary confirmation) | Cited by the fatal-attacks paper; not independently sourced |

**A THIRD major BSL-adjacent time-series data point for this study, and one that complicates the emerging picture:** unlike Denmark (13-breed ban INTRODUCED in 2010, no significant bite-rate effect found) and Manitoba (BSL INTRODUCED across jurisdictions 1984-2006, weak/mixed hospitalisation-rate reduction), Italy's natural experiment runs in the OPPOSITE direction -- a national BSL was in force 1984-2009 and then REPEALED. Comparing the two Italian eras, fatal dog attacks rose from 1.28/year (1984-2009, BSL era) to 3.18/year (2009-2025, post-repeal era). Taken at face value this is the one BSL-related time-series result in this whole study that points TOWARD breed-specific legislation having a protective effect -- the opposite direction from Denmark and (more ambiguously) Manitoba. **However, this comparison is confounded by Italy's dog population reportedly more than doubling over the relevant period (per the source's own citation, not independently verified) -- a rising raw fatality count is not the same as a rising per-capita risk, and the source paper does not itself compute or claim a controlled per-capita rate for either era.** This should be presented in the final report as a genuine complicating/nuancing data point for the management-culture-over-breed-legislation thesis, not smoothed over or omitted to preserve a clean narrative -- see the cross-reference note added to variables/management-practices-and-culture.md's existing Denmark/Manitoba Interpretive Note.
