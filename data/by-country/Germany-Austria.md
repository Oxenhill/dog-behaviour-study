...
- Austria-specific shelter/surrender data: **PARTIALLY RESOLVED Session 11** -- two single-site/regional data points now extracted: Pfotenhilfe OO (Upper Austria, 40 dogs taken in since Jan 2024, 3-5 daily surrender requests) and Tierschutz Austria (~10,000 total animals at their facility in 2024, no dog-specific breakdown, appears to be one location despite the national organisation name). Neither aggregates to a genuine NATIONAL Austrian shelter/surrender figure, which remains a complete gap -- a national federation-level survey akin to Germany's Tierschutzbund Trendumfrage (Session 7) has not been located for Austria despite two separate searches this session.
