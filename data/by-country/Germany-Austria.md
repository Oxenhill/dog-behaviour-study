...
**Session 11 (autonomous continuation) -- a second, small, regional German data point found:** Kolbe, Bingert, Marzheuser, Buttner, "Vorsicht: bissig! Hundebissverletzungen in der klinischen Rechtsmedizin," Die Chirurgie (Springer), 2022 -- **[quality: A, peer-reviewed, but a small single-institution sample]**. A retrospective 2004-2021 review at the Institute of Forensic Medicine, Universitatsmedizin Rostock (Mecklenburg-Vorpommern): only 19 cases / 17 injured persons over 18 years -- 7 children (median age 3) and 10 adults (median age 24); 8 hospitalised, 5 treated ambulatory, 4 with no clinical presentation; hospital stays 2-17 days. The authors themselves note this small case count "stands in stark contrast to international studies." This does NOT move the national-rate gap forward (tiny regional sample, forensic-medicine referrals only, not a population-based rate) but adds genuine demographic/severity detail (notably the very young median age of child victims, 3 years) not previously available for Germany -- logged as a minor supporting data point, not a resolution.

**Also attempted this session:** "Bite injuries at a level 1 trauma center in Germany" (ResearchGate) -- 429 rate-limited, the standard ResearchGate failure mode seen throughout this project; not retried per the efficiency rule. A further German national bite-rate search (Destatis/RKI, this session and Session 10-11 combined) remains blocked across every route tried (3+ attempts) -- this gap should now be considered firmly closed to automated search; a future session should consider it resolved-as-blocked rather than a live research target, unless a genuinely new type of source (e.g. a specific peer-reviewed German national-registry study, if one is ever published) surfaces.
...
**Second Austrian data point, same session -- Tierschutz Austria (Vienna-area facility).** **[quality: C -- single organisation's own press release, appears to be one facility's figures, not aggregated national data despite the organisation's national name/remit]**

Source: OTS.at press release, January 2025, "Rekordzahl bei Tieraufnahmen: Jedes vierte Haustier ausgesetzt" ("Record number of animal admissions: every fourth pet abandoned"), published by Tierschutz Austria (Austria's oldest animal welfare organisation, founded 1846).
| Metric | Figure | Year |
|--------|--------|------|
| Total animals admitted at their facility | ~10,000 | 2024 |
| Small-animal (rabbits, guinea pigs) owner surrenders | 946 | 2024 |
| Animals found by the public (not surrendered) | 3,883 (~two-thirds of admissions) | 2024 |
| Animals reunited with owners | 26% | 2024 -- implies roughly three-quarters were not, i.e. effectively abandoned rather than lost |
| Cited trend | Rising number of abandoned SICK animals specifically | 2024 |

**Caveat -- must be preserved:** the press release does not break down the ~10,000 total by species (dogs vs cats vs other), and despite the organisation's national name, the figures read as describing "their facility" (singular), i.e. one shelter/location's admissions, not an aggregated national count across Austrian shelters. This is therefore a SECOND regional/single-site Austrian data point, not a resolution of the national gap -- logged alongside the Pfotenhilfe OO figure above as a further indicative point, not combined with it (different organisations, different regions, no dog-specific breakdown here to compare against Pfotenhilfe OO's dog-specific count).
...
- Austria-specific shelter/surrender data: **FURTHER RESOLVED Session 11 (autonomous continuation) -- a genuine NATIONAL-SCOPE Austrian government shelter study located.** **[quality: A -- Austrian Federal Ministry of Health (Bundesministerium fuer Arbeit, Soziales, Gesundheit, Pflege und Konsumentenschutz) official study, published via verbrauchergesundheit.gv.at]**

Source: "Beurteilung von Tierheimen in Österreich" (Assessment of Animal Shelters in Austria), published April 2011, study period March-September 2010.
| Metric | Figure |
|--------|--------|
| Officially permitted/registered shelters nationally | 46 |
| Shelters visited/surveyed for the study | 30 (29 housing dogs, 30 housing cats), plus 10 re-visited for reliability testing |
| Average animals per shelter | 164 +/- 248 (range 14-1,348) |
| **Average dogs per shelter** | **47** |
| Average cats per shelter | 84 |
| Shelters with dog quarantine facilities | 76% |
| Shelters with dedicated dog medical wards | 28% |
| Shelters with training areas | 48% |
| Caregiver time per animal per day | ~15 minutes on average |
| Shelter staff with animal-specific training | ~1/3 |

**Significance and caveats -- must be preserved:** this is the first genuinely NATIONAL-scope Austrian shelter dataset found across four sessions of searching (unlike the two single-site/regional Session-11 finds above, Pfotenhilfe OO and Tierschutz Austria) -- it samples 30 of Austria's 46 officially registered shelters, spanning the whole country. However, it is dated (2010/2011 fieldwork, well outside this study's typical 2014-2024 primary window) and it measures shelter INFRASTRUCTURE/welfare-standards (staffing, quarantine capacity, medical facilities) and average POPULATION SIZE, not an annual intake/surrender COUNT or trend -- so it still does NOT give a "X dogs surrendered in Austria in year Y" figure comparable to Germany's Tierschutzbund intake-adjacent data or Canada's Humane Canada intake counts. Treat as: national scope RESOLVED for shelter infrastructure/population-size context; national intake/surrender COUNT remains a gap. A national federation-level SURVEY (akin to Germany's Tierschutzbund Trendumfrage) specifically covering current (2020s) intake/surrender trends was searched for again this session and still not found -- Austria appears to lack the kind of national animal-welfare-federation umbrella body that Germany's Tierschutzbund provides, which may explain why this kind of data is structurally harder to find for Austria than for Germany.

**Also checked this session, confirmed NOT useful for bite/shelter data:** Austria's national Veterinärjahresbericht (Veterinary Annual Report) series (1998-2018 available) -- covers veterinary administration and disease monitoring, explicitly does not include dog bite or shelter statistics. Ruled out as a route, not a further gap to chase.
- Germany national bite-rate gap: attempted again Session 11 via Destatis/gbe-bund.de official hospital-diagnosis statistics (which would, if accessible, give a genuine ICD-10 W54 national hospitalisation count) -- both the gbe-bund.de query page and a Destatis publication page returned 404 errors. Two distinct URLs attempted and blocked this session (in addition to the d-nb.info 403 from the prior session) -- this specific route (official government hospital-diagnosis statistics portals) now looks structurally hard to access via direct fetch, and may require the user's own browser access or a different query interface. Logged as a firmly blocked route rather than an under-searched one.
