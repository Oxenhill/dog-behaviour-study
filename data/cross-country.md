...
- ⚠️ Italy (NEW, opened Session 11) — has grown substantially within the session: a regional (Sicily) bite-hospitalisation dataset (0.648->1.162 per 100,000, 2012-2021, comparability to UK/Australia/NZ unconfirmed); a NATIONAL fatal-dog-attack registry (54 deaths, 2009-2025) with a reconciled BSL-era timeline (see variables/breed-legislation-timeline.md) and a strong institutional breed-neutrality quote (ENCI/veterinary associations, 2006/2007); a national leash/muzzle ordinance (Aug 2024, breed-neutral, renewing 2009 policy) and a distinctive reactive/individualised owner-training model; and a first C-BARQ validation study (803 owners, 13-factor structure). Only shelter/surrender data (with an isolated behaviour-reason category) remains unresearched for Italy.
