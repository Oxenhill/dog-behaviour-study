...
data-sources.md (Session 11 additions table; New Zealand rows updated; Session 7 Berlin CSV row updated to reflect extraction)
_PROJECT_STATE.md (this file — Session 11 log, extended)
```
